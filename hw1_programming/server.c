...
int main(int argc, char** argv) {
    ...
    while (1) {
        ...
        int totalReadFds = poll(readFdArray, largestFd  - BulletinFd, 2);
        ...
        int totalWriteFds = poll(writeFdArray, largestFd - BulletinFd, 2);
        curFd = BulletinFd + 1;
        while (totalWriteFds) {
